...
const testimonials = [
  {
    ...
    role: "Executivo",
    content:
      "Devido à pluralidade de moradores, condomínios possuem regras de convivência materializadas em seus regulamentos, regimentos ou convenções. Tais regras têm como objetivo harmonizar a convivência estabelecendo padrões de conduta e proibindo determinados comportamentos inadequados",
    avatar:
  ...
  },
  {
    ...
    role: "Músico",
    content:
      "Portanto, solicito a aplicação de advertência ou multa aos infratores, na forma do artigo (informar) do Regulamento Interno, para que as irregularidades deixem de ocorrer.",
    avatar:
